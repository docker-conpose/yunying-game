      ...
      <el-card class="box-card cardDiv1">
        ...
        <el-col :span="5">
          <div class="box-div card2">
            <div class="webBox">
              <div class="webO">今日在线数量:</div>
              <div class="webT">212</div>
            </div>
          </div>
        </el-col>
        <el-col :span="5">
      ...
      <el-col :span="14" style="margin-right: 10px">
        <el-card class="box-card cardDiv2">
          <div slot="header" class="clearfix">
            <span style="margin-right: 30px">用户充值信息</span>
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <span v-if="scope.row.status==='1'" style="color: #FF9933">待确认</span>
                <span v-if="scope.row.status==='2'" style="color: #FF5722">已拒绝</span>
                <span v-if="scope.row.status==='3'" style="color: #1890ff">已充值</span>
              </template>
            </el-table-column>
            <el-table-column
              label="操作">
        ...
        <el-card class="box-card cardDiv2">
          ...
          <el-table
            ...
            <el-table-column
              ...
              label="客户级别">
              <template slot-scope="scope">
                <span v-if="scope.row.level==='1'"><el-tag type="danger">高级客户</el-tag></span>
                <span v-if="scope.row.level==='2'"><el-tag type="success">中级客户</el-tag></span>
                <span v-if="scope.row.level==='3'"><el-tag type="warning">初级客户</el-tag></span>
                <span v-if="scope.row.level==='4'"><el-tag type="info">普通客户</el-tag></span>
              </template>
            </el-table-column>
            <el-table-column
              label="操作">
  ...
  methods: {
    ...
    setLineData(){
      ...
      option = {
        ...
        series: [
          {
            data: [1509, 2303, 2245, 2182, 1351, 1473, 2602],
            type: 'line',
            itemStyle: {
              normal: {
                color: "#2ec7c9",
    ...
    setBireData(){
      ...
      option = {
        ...
        yAxis: {
          ...
          data: ['今日用户登录次数', '今日玩家消费','今日活动赠与','今日玩家充值',  ], //y轴显示文字
          axisTick: {
            show: false
          },
          axisLine: {
